...
%\begin{enumerate}
%
%\item  we identify the core security properties that a payment with dispute resolution scheme should have and formally define them.
%
%\item we propose an efficient candidate construction, PwDR, and  prove its security.
%
%\item   we analyse  the construction's cost.     
%\end{enumerate}
...
%We provide a notation table and more detail about Bloom filters in appendices \ref{sec:notation-table} and \ref{sec::bloom-filter-}, respectively. In Appendix \ref{sec::Variant-1-Theorem-proof}, we provide the main security theorem and related  proof of the first variant of   our threshold voting protocol.  In Appendix \ref{sec::Generic-Verdict-Encoding-Decoding-Protocols}, we provide the full protocol of the second variant of our  threshold voting scheme. 
