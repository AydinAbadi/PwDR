...
% \end{equation*}
 %
 For instance, when $n=10$ and  $e=6$, then $|W|=386$. Appendix \ref{sec:: Further-Discussion-on-the-Encoding-decoding-Protocol} provides more discussions on the above protocols.
