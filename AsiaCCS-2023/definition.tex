...
This section outlines a formal definition of the payment with dispute resolution  ($\mathsf{pwdr}$). We refer readers to the paper's full version \cite{PwDR-full-ver} for a more detailed formal definition. 
%
