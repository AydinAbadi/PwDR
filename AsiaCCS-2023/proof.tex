...
\vspace{-1mm}
In this section, we prove the security theorem of the PwDR, i.e., Theorem \ref{theorem::PwDR-security}. %We first present the PwDR protocol's main theorem. 
%
...
If the encryption schemes are CPA-secure, and the SAP and encoding-decoding schemes (i.e., PVE and FVD)  are secure, then the PwDR is privacy-preserving, w.r.t.  Definition \ref{def-a::privacy}.  
\end{lemma}
