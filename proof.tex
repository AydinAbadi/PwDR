...
In this section, we present the proof sketch of the PwDR protocol's security theorem, i.e., Theorem \ref{theorem::PwDR-security}. 
...
%We first present the PwDR protocol's main theorem. 
%
%
