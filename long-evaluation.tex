...
%we present a detailed evaluation of the PwDR protocol’s computation and communication complexity. %Table \ref{table::PwDR-Asymptotic-Cost} summarises the result. 
