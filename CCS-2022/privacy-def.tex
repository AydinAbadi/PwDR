...
{\small{
\begin{center}
\begin{mybox}[colback=white,  width=80mm, height=59mm, left=-1mm, drop fuzzy shadow southwest]{$\mathsf{Exp}_{\st 3}^{\st\mathcal{A}_{\st 1}}(1^{\st\lambda}\text{, }  {aux})$}
...
\begin{center}
{\small{
\begin{mybox}[colback=white,  width=80mm, height=63mm, left=-1mm, drop fuzzy shadow southwest]{$\mathsf{Exp}_{\st 4}^{\st\mathcal{A}_{\st 2}}(1^{\st\lambda}\text{, }  {aux})$}
%\fbox{\begin{minipage}{3.8 in}
\vspace{-.5mm}
$$
  \begin{array}{l}
