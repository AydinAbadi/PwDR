...
In this section, we analyse the PwDR protocol's (computation and communication) complexity, its concrete runtime, and transactions latency.  Tables \ref{table::PwDR-Asymptotic-Cost} and \ref{table::PwDR-runtime} summarize the asymptotic and performance analysis respectively. 
\input{table-cost}
