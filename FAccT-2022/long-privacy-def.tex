...
\begin{center}
\begin{mybox}[colback=white,  width=88mm, height=71mm,]{$\mathsf{Exp}_{\st 3}^{\st\mathcal{A}_{\st 1}}(1^{\st\lambda}\text{, }  {aux})$}
...
%%%%%%%%%%%%%%%--EXp_4%%%%%%%%%%%%%%%
\begin{center}
\begin{mybox}[colback=white,  width=88mm, height=76mm,]{$\mathsf{Exp}_{\st 4}^{\st\mathcal{A}_{\st 2}}(1^{\st\lambda}\text{, }  {aux})$}
%\fbox{\begin{minipage}{3.8 in}
$$
  \begin{array}{l}
%
