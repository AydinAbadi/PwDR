...
%
\begin{center}
\begin{mybox}[colback=white,  width=119mm, height=29mm,]{$\mathsf{Exp}_{\st 1}^{\st\mathcal{A}}(1^{\st\lambda}\text{, }  {aux})$}
...
%
\begin{center}
\begin{mybox}[colback=white,  width=119mm, height=33mm,]{$\mathsf{Exp}_{\st 2}^{\st\mathcal{A}}(1^{\st\lambda}\text{, }  {aux})$}
%\fbox{\begin{minipage}{3.8 in}
\vspace{-1mm}
$$
  \begin{array}{l}
