...
\vspace{-.5mm}
\begin{center}
\begin{mybox}[colback=white,  width=119mm, height=28mm, drop fuzzy shadow southwest]{$\mathsf{Exp}_{\st 1}^{\st\mathcal{A}}(1^{\st\lambda}\text{, }  {aux})$}
...
\vspace{-.5mm}
\begin{center}
\begin{mybox}[colback=white,  width=119mm, height=32.5mm, drop fuzzy shadow southwest]{$\mathsf{Exp}_{\st 2}^{\st\mathcal{A}}(1^{\st\lambda}\text{, }  {aux})$}
%\fbox{\begin{minipage}{3.8 in}
\vspace{-1.4mm}
$$
  \begin{array}{l}
