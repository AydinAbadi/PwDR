...
\begin{center}
\begin{mybox}[colback=white,  width=98mm, height=58mm,]{$\mathsf{Exp}_{\st 1}^{\st\mathcal{A}}(1^{\st\lambda}\text{, }  {aux})$}
...
\begin{center}
\begin{mybox}[colback=white,  width=98mm, height=62mm,]{$\mathsf{Exp}_{\st 2}^{\st\mathcal{A}}(1^{\st\lambda}\text{, }  {aux})$}
%\fbox{\begin{minipage}{3.8 in}
$$
  \begin{array}{l}
%
