...
%
\item[$\bullet$] Bank $\mathcal{B}$: it is a regular bank  providing an online banking. We assume it is corrupted by a non-colluding active adversary. We assume  any change to the online banking system's source code is transparent and  can be detected. 
...
%
 ...
 We assume they   interacted with each  other,  to agree on a secret key, $\bar k_{\st 0}$, and a pair of keys $({pk}_{\st\mathcal {D}}, {sk}_{\st\mathcal {D}})$  of an asymmetric key encryption.
%
