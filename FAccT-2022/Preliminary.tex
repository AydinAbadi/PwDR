...
%
We will provide a formal definition of the  PwDR scheme in Section \ref{sec::def}. 
%
\begin{itemize}
%
...
%
\item[$\bullet$]  A committee of arbiters $\{\mathcal{D}_{\st 1},..., \mathcal{D}_{\st n}\}$: it consists of  trusted third-party authorities or regulators (e.g.,  financial conduct authority, financial ombudsman service). They compile  complaints    and provide their   verdicts. If needed, they can access the banking   backend software to conduct  investigations. We assume the arbiters  interacted with each other   to agree on (a) a secret key, $\bar k_{\st 0}$, and (b) a pair of keys $({pk}_{\st\mathcal {D}}, {sk}_{\st\mathcal {D}})$  of an asymmetric key encryption.
%
