...
\begin{center}
\begin{mybox}[colback=white,  width=85mm, height=70mm,]{$\mathsf{Exp}_{\st 3}^{\st\mathcal{A}_{\st 1}}(1^{\st\lambda}\text{, }  {aux})$}
...
%%%%%%%%%%%%%%%--EXp_4%%%%%%%%%%%%%%%
\begin{center}
\begin{mybox}[colback=white,  width=85mm, height=78mm,]{$\mathsf{Exp}_{\st 4}^{\st\mathcal{A}_{\st 2}}(1^{\st\lambda}\text{, }  {aux})$}
%\fbox{\begin{minipage}{3.8 in}
\vspace{-1.2mm}
$$
  \begin{array}{l}
