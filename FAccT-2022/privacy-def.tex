...
\vspace{-2mm}
\begin{center}
\begin{mybox}[colback=white,  width=121mm, height=33mm, drop fuzzy shadow southwest]{$\mathsf{Exp}_{\st 3}^{\st\mathcal{A}_{\st 1}}(1^{\st\lambda}\text{, }  {aux})$}
...
\vspace{-2.8mm}
\begin{center}
\begin{mybox}[colback=white,  width=121mm, height=36mm, drop fuzzy shadow southwest]{$\mathsf{Exp}_{\st 4}^{\st\mathcal{A}_{\st 2}}(1^{\st\lambda}\text{, }  {aux})$}
%\fbox{\begin{minipage}{3.8 in}
\vspace{-2mm}
$$
  \begin{array}{l}
