...
%\Bigg(
%
  \Big((m^{\st\mathcal{(B)}}_{\st1}=warning) \wedge (\sum\limits_{\st j=1}^{\st n}w_{\st 1,j}< {n})\Big)\\
  %
  \vee \Big((\sum\limits_{\st j=1}^{\st n}w_{\st 1,j}={n}) \wedge ( {v}_{\st 1}=0)\Big)
 % \Bigg)
  \\
  %
\vee
  %\Bigg(
    \Big((\mathtt{checkWarning}(m^{\st\mathcal{(B)}}_{\st1})= 1) \wedge (\sum\limits_{\st j=1}^{\st n}w_{\st 2,j}< {n})\Big)\\
  %
  \vee \Big((\sum\limits_{\st j=1}^{\st n}w_{\st 2,j}= {n}) \wedge ({v}_{\st 2}=0)\Big)
  %\Bigg)
  \\
  %
  \vee 
  ...
  %
  \vee \Big((\sum\limits_{\st j=1}^{\st n}w_{\st 3,j}< {n}) \wedge ( {v}_{\st 3}=0)\Big)
  %
  %\Bigg)
  \\
  %
