...
\caption{ \small The PwDR protocol's asymptotic cost. In the table, $n$ denotes the total number of arbiters.} \label{table::PwDR-Asymptotic-Cost} 
\begin{center}
...
%\scriptsize Smart Contract&\scriptsize$O(1)$&-\\ 
 ...
 %\cellcolor[gray]{.9}\multirow{-4}{*}{\rotatebox[origin=c]{0}
